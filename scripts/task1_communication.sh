...
python3 source/task1.py --model-type communication --controller omniscient --generate-split --plots-net --train-net --net-input prox_values --avg-gap 8 --dataset avg_gap-8 --model net1
...
python3 source/task1.py --model-type communication --controller omniscient --generate-split --plots-net --train-net --net-input prox_comm --avg-gap 8 --dataset avg_gap-8 --model net2
...
python3 source/task1.py --model-type communication --controller omniscient --generate-split --plots-net --train-net --net-input prox_comm --avg-gap 13 --dataset avg_gap-13 --model net3
...
python3 source/task1.py --model-type communication --controller omniscient --generate-split --plots-net --train-net --net-input prox_comm --avg-gap 25 --dataset avg_gap-25 --model net4
...
python3 source/task1.py --model-type communication --controller omniscient --generate-split --plots-net --train-net --net-input all_sensors --avg-gap 8 --dataset avg_gap-8 --model net5
...
python3 source/task1.py --model-type communication --controller omniscient --generate-split --plots-net --train-net --net-input all_sensors --avg-gap 13 --dataset avg_gap-13 --model net6
...
python3 source/task1.py --model-type communication --controller omniscient --generate-split --plots-net --train-net --net-input all_sensors --avg-gap 25 --dataset avg_gap-25 --model net7
