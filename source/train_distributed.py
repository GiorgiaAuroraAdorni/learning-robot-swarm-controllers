...
def run_distributed(file, runs_dir, model_dir, model_img, model, ds, ds_eval, train, generate_split, plots,
    ...
    sensing, groundtruth = utils.from_indices_to_dataset(runs_dir, train_indices, validation_indices, test_indices, net_input)

    # Generate the tensors
    t_d_test, t_d_train, t_d_valid = utils.from_dataset_to_tensors(x_train, y_train, x_valid, y_valid, x_test, y_test)
